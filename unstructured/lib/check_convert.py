...
def check_convert(file_path):
    ...
    20250320-233000
    """
    converter_url = os.getenv("CONVERTER_LIBREOFFICE_URL", "http://converter_libreoffice:80") # 從環境變數取得 converter-libreoffice 的 URL，如果沒有設定，預設為 http://converter_libreoffice:8000
    try:
